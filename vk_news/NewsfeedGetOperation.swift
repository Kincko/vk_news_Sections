...
class NewsfeedGetOperation: Operation
{
    var count: Int
    ...
    init(withCount count: Int, success: @escaping (NSArray) -> Void, failure: @escaping (Int) -> Void)
    {
        self.count = count
    ...
    override func main()
    {
        ...
        internetTask = API_WRAPPER.getNews(withCount: count, successBlock: { (jsonResponse) in
